...
var _populateCards = require("./home/script_files/populateCards");
var _populateCardsDefault = parcelHelpers.interopDefault(_populateCards);
var _showMore = require("./home/script_files/showMore");
var _showMoreDefault = parcelHelpers.interopDefault(_showMore);
var _homesCategories = require("./home/script_files/homes_categories");
var _homesCategoriesDefault = parcelHelpers.interopDefault(_homesCategories);
var _populateNearCards = require("./home/script_files/populateNearCards");
var _populateNearCardsDefault = parcelHelpers.interopDefault(_populateNearCards);
var _populateHomeInfo = require("./home/script_files/populateHomeInfo");
var _populateHomeInfoDefault = parcelHelpers.interopDefault(_populateHomeInfo);
var _populateAgentPage = require("./home/script_files/populateAgentPage");
var _populateAgentPageDefault = parcelHelpers.interopDefault(_populateAgentPage);
var _populateAgentListings = require("./home/script_files/populateAgentListings");
var _populateAgentListingsDefault = parcelHelpers.interopDefault(_populateAgentListings);
var _openProfile = require("./home/script_files/openProfile");
...
function animationLeave(done) {
    ...
    return (0, _gsapDefault.default).to(cover, {
    ...
    transitions: [
        {
            ...
            once ({ next  }) {
                ...
                (0, _populateCardsDefault.default)((0, _homesCategoriesDefault.default));
                (0, _populateNearCardsDefault.default)((0, _homesCategoriesDefault.default));
                (0, _openProfileDefault.default)();
            },
            leave ({ current  }) {
                (0, _gsapDefault.default).set(current.container.children[0], {
                    clipPath: "inset(0 100% 0 0)"
                });
        ...
        },
        {
            ...
            once ({ next  }) {
                ...
                (0, _populateHomeInfoDefault.default)((0, _homesCategoriesDefault.default));
                (0, _showMoreDefault.default)();
            },
            leave ({ current  }) {
                (0, _gsapDefault.default).set(current.container.children[0], {
                    clipPath: "inset(0 100% 0 0)"
        ...
        },
        {
            ...
            once ({ next  }) {
                animationOnce(next.container.children[0]);
                (0, _populateAgentPageDefault.default)((0, _homesCategoriesDefault.default));
                (0, _populateAgentListingsDefault.default)((0, _homesCategoriesDefault.default));
            },
            leave ({ current  }) {
                (0, _gsapDefault.default).set(current.container.children[0], {
                    clipPath: "inset(0 100% 0 0)"
...
},{"@barba/core":"gIWbX","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./home/script_files/populateCards":"ekdMU","./home/script_files/homes_categories":"2bbjq","./home/script_files/populateHomeInfo":"eaS2f","./home/script_files/populateNearCards":"k4VMP","./home/script_files/showMore":"5vKjK","./home/script_files/populateAgentPage":"fn7T3","./home/script_files/populateAgentListings":"k1rTf","./home/script_files/openProfile":"8uSH1"}],"gIWbX":[function(require,module,exports) {
!function(t, n) {
    module.exports = n();
}(this, function() {
    function t(t, n) {
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ekdMU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _randomHomeIndex = require("./randomHomeIndex");
var _randomHomeIndexDefault = parcelHelpers.interopDefault(_randomHomeIndex);
function populateCard(info) {
    const items = document.querySelectorAll(".item");
    items.forEach((item, index)=>{
        const z = (0, _randomHomeIndexDefault.default)(3);
        ...
        btn.addEventListener("click", ()=>{
            localStorage.setItem("home-data", JSON.stringify({
                cardIndex: index,
                cardInfoNo: z
            }));
        });
...
exports.default = populateCard;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./randomHomeIndex":"6axoE"}],"6axoE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const randomHomeIndex = (num)=>Math.floor(Math.random() * num);
exports.default = randomHomeIndex;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2bbjq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = [
    {
        agent_name: "Christian Macmillan",
        agent_phone_no: "+465274624300",
        agent_description: "Unde deleniti dolorum ut architecto natus ea, pariatur, neque distinctio aspernatur, dicta molestiae rem doloribus vero vel ratione error modi nihil. Repellendus fuga consequuntur, praesentium quia suscipit aperiam pariatur incidunt iste quisquam, iure hic omnis, illum officia ea autem veritatis molestias optio perspiciatis odio animi alias ducimus. Quis alias ab numquam temporibus voluptatem veniam odio dolores officiis! ",
        agent_location: "Praesentium, London",
        agent_image: "agent-1",
        agent_listings: [
            {
                house_name: "Beaches",
                house_image: "agent-1-1",
                house_description: "Aperiam pariatur incidunt iste quisquam, iure hic omnis, illum officia ea autem veritatis molestias optio perspiciatis odio animi alias ducimus. Quis alias ab numquam temporibus voluptatem veniam odio dolores officiis! Libero quis hic obcaecati ex id placeat eaque. Dolorum ad ut laborum illo quisquam rem. Quam tempore ullam dolor delectus sit cum obcaecati unde consequatur tenetur, reiciendis rem numquam nostrum porro excepturi enim fugiat officiis nihil labore harum. Odio quis recusandae id, magni corrupti quas a accusamus veniam officia dolore! Maiores officia autem aperiam doloremque modi dignissimos voluptates ipsa",
                house_price: "141,000",
                house_location: "Suscipit, Aperiam",
                house_land_size: "350",
                no_of_bedrooms: "8",
                light_time: "16"
            },
            {
                house_name: "Clarence",
                house_image: "agent-1-2",
                house_description: "Placeat, ipsa eos. Nostrum alias iste delectus corrupti enim nesciunt architecto doloremque rem culpa minima eius deserunt omnis ratione, voluptatem quae! Ducimus quaerat repellendus doloribus iste temporibus dolore fugiat aliquid recusandae explicabo modi cum error culpa odit commodi dolorum quisquam, vitae ea est quis aperiam minus sint dolores necessitatibus! Amet asperiores eius veniam ipsum ex impedit inventore tempora laborum eaque? Atque odit sit facere accusamus impedit consequatur esse maxime totam beatae est, iusto quo voluptate ipsam nam sapiente nemo dolores adipisci vitae ex similique quam laudantium neque",
                house_price: "177,000",
                house_location: "Temoribus, Voluptatem",
                house_land_size: "550",
                no_of_bedrooms: "10",
                light_time: "13"
            },
            {
                house_name: "Corner House",
                house_image: "agent-1-3",
                house_price: "182,000",
                house_description: "Hic corrupti asperiores tempora! Earum, maiores facilis ipsum esse, eum, quis laboriosam autem nesciunt distinctio harum a ea vel! Sint nulla quod qui repellendus in, libero nemo sequi a ipsum. Illo maiores illum dolore aliquam laudantium, dicta, magnam vel optio at corporis architecto doloribus aspernatur ipsa mollitia provident facilis nihil quidem natus inventore tempora dolorem neque! Fuga et officia qui a autem suscipit nihil tenetur esse inventore, animi dicta enim quibusdam possimus repellat quae consectetur officiis voluptatem maxime tempore error eligendi. Ad laboriosam eveniet assumenda harum repellat unde, consectetur",
                house_location: "Praesentium ,Eligendi",
                house_land_size: "200",
                no_of_bedrooms: "8",
                light_time: "22"
            }
    ...
    {
        agent_name: "Ben Andrews",
        agent_phone_no: "+6864864356882",
        agent_description: "Eius hic corrupti asperiores tempora! Earum, maiores facilis ipsum esse, eum, quis laboriosam autem nesciunt distinctio harum a ea vel! Sint nulla quod qui repellendus in, libero nemo sequi a ipsum. Illo maiores illum dolore aliquam laudantium, dicta, magnam vel optio at corporis architecto doloribus aspernatur ipsa mollitia provident facilis nihil quidem natus inventore tempora dolorem neque! Fuga et officia qui a autem",
        agent_location: "Aspernatur ipsa, Mollitia",
        agent_image: "agent-2",
        agent_listings: [
            {
                house_name: "Fairview",
                house_image: "agent-2-1",
                house_description: "Consequuntur dolorum porro? Ab eius similique illo, recusandae ducimus rerum tenetur at necessitatibus culpa ullam nisi molestias amet, nesciunt officiis sed? Aperiam nemo laboriosam ut. Quod, sint magnam ipsa sunt dicta obcaecati libero excepturi aliquam reiciendis odio recusandae! Facilis minima ipsum aperiam unde deleniti dolorum ut architecto natus ea, pariatur, neque distinctio aspernatur, dicta molestiae rem doloribus vero vel ratione error modi nihil. Repellendus fuga consequuntur, praesentium quia suscipit aperiam pariatur incidunt iste quisquam, iure hic omnis, illum officia ea autem veritatis molestias optio perspiciatis odio animi alias ducimus. Quis alias ab numquam temporibus voluptatem veniam odio dolores officiis!",
                house_price: "192,000",
                house_location: "Molestiae rem, Doloribus",
                house_land_size: "730",
                no_of_bedrooms: "8",
                light_time: "18"
            },
            {
                house_name: "Firs",
                house_image: "agent-2-2",
                house_description: "Illo maiores illum dolore aliquam laudantium, dicta, magnam vel optio at corporis architecto doloribus aspernatur ipsa mollitia provident facilis nihil quidem natus inventore tempora dolorem neque! Fuga et officia qui a autem suscipit nihil tenetur esse inventore, animi dicta enim quibusdam possimus repellat quae consectetur officiis voluptatem maxime tempore error eligendi. Ad laboriosam eveniet assumenda harum repellat unde, consectetur beatae cupiditate cum, doloribus ullam commodi provident amet dolorem minima explicabo labore nobis. Placeat, ipsa eos. Nostrum alias iste delectus ",
                house_price: "141,000",
            ...
            {
                house_name: "Gables",
                house_image: "agent-2-3",
                house_description: "Eius veniam ipsum ex impedit inventore tempora laborum eaque? Atque odit sit facere accusamus impedit consequatur esse maxime totam beatae est, iusto quo voluptate ipsam nam sapiente nemo dolores adipisci vitae ex similique quam laudantium neque non aspernatur. Illum facilis amet commodi, quo hic autem ullam nobis deserunt voluptates repellat praesentium natus esse? Id suscipit obcaecati nulla aspernatur soluta cupiditate similique nobis velit fugiat nam deserunt, officiis voluptas molestias consequatur? Pariatur corporis inventore impedit accusamus consequatur dolorum quam fuga odit cumque aperiam. Laboriosam temporibus",
                house_price: "180,000",
                house_location: "Ipsam, Adipisci",
                house_land_size: "730",
                no_of_bedrooms: "9",
                light_time: "24"
            }
    ...
    {
        agent_name: "Sheila James",
        agent_phone_no: "+745842876328",
        agent_description: "Quam tempore ullam dolor delectus sit cum obcaecati unde consequatur tenetur, reiciendis rem numquam nostrum porro excepturi enim fugiat officiis nihil labore harum. Odio quis recusandae id, magni corrupti quas a accusamus veniam officia dolore! Maiores officia autem aperiam doloremque modi dignissimos voluptates ipsa odit",
        agent_image: "agent-3",
        agent_location: "Maiores officia, Autem",
        agent_listings: [
            {
                house_name: "Autumn Tints",
                house_image: "agent-3-1",
                house_description: "Quod, sint magnam ipsa sunt dicta obcaecati libero excepturi aliquam reiciendis odio recusandae! Facilis minima ipsum aperiam unde deleniti dolorum ut architecto natus ea, pariatur, neque distinctio aspernatur, dicta molestiae rem doloribus vero vel ratione error modi nihil. Repellendus fuga consequuntur, praesentium quia suscipit aperiam pariatur incidunt iste quisquam, iure hic omnis, illum officia ea autem veritatis molestias optio perspiciatis odio animi alias ducimus. Quis alias ab numquam temporibus voluptatem veniam odio dolores officiis!",
                house_price: "136,000",
                house_location: "Vero, Modi",
                house_land_size: "300",
                no_of_bedrooms: "7",
                light_time: "10"
            },
            {
                house_name: "Barefoot House",
                house_image: "agent-3-2",
                house_description: "Beatae cupiditate cum, doloribus ullam commodi provident amet dolorem minima explicabo labore nobis. Placeat, ipsa eos. Nostrum alias iste delectus corrupti enim nesciunt architecto doloremque rem culpa minima eius deserunt omnis ratione, voluptatem quae! Ducimus quaerat repellendus doloribus iste temporibus dolore fugiat aliquid recusandae explicabo modi cum error culpa odit commodi dolorum quisquam, vitae ea est quis aperiam minus sint dolores necessitatibus! Amet asperiores eius veniam ipsum ex impedit inventore.",
                house_price: "188,000",
                house_location: "Ventore tempora, Colorem",
                house_land_size: "510",
                no_of_bedrooms: "12",
                light_time: "17"
            },
            {
                house_name: "Gables",
                house_image: "agent-3-3",
                house_description: "Orro excepturi enim fugiat officiis nihil labore harum. Odio quis recusandae id, magni corrupti quas a accusamus veniam officia dolore! Maiores officia autem aperiam doloremque modi dignissimos voluptates ipsa odit natus ut, cum ea sapiente. Cum sed ad doloribus perferendis quae. Eius hic corrupti asperiores tempora! Earum, maiores facilis ipsum esse, eum, quis laboriosam autem nesciunt distinctio harum a ea vel! Sint nulla quod qui repellendus in, libero nemo sequi a ipsum. Illo maiores illum dolore aliquam laudantium",
                house_price: "142,000",
                house_location: "Sint, Repellendusi",
                house_land_size: "670",
                no_of_bedrooms: "11",
                light_time: "20"
            }
    ...
    {
        agent_name: "Peter Stone",
        agent_phone_no: "+78774662288",
        agent_description: "Praesentium quia suscipit aperiam pariatur incidunt iste quisquam, iure hic omnis, illum officia ea autem veritatis molestias optio perspiciatis odio animi alias ducimus. Quis alias ab numquam temporibus voluptatem veniam odio dolores officiis! Libero quis hic obcaecati ex id placeat eaque. Dolorum ad ut laborum illo quisquam rem. Quam tempore ullam dolor delectus sit cum obcaecati unde consequatur tenetur, reiciendis rem numquam nostrum porro",
        agent_image: "agent-4",
        agent_location: "Reiciendis rem, Numquam.",
        agent_listings: [
            {
                house_name: "Winterfell",
                house_image: "agent-4-1",
                house_description: "Eius hic corrupti asperiores tempora! Earum, maiores facilis ipsum esse, eum, quis laboriosam autem nesciunt distinctio harum a ea vel! Sint nulla quod qui repellendus in, libero nemo sequi a ipsum. Illo maiores illum dolore aliquam laudantium, dicta, magnam vel optio at corporis architecto doloribus aspernatur ipsa mollitia provident facilis nihil quidem natus inventore tempora dolorem neque! Fuga et officia qui a autem suscipit nihil tenetur esse inventore, animi dicta enim quibusdam possimus repellat quae consectetur officiis",
                house_price: "120,000",
                house_location: "Corporis architecto, Doloribus",
                house_land_size: "435",
                no_of_bedrooms: "6",
                light_time: "14"
            },
            {
                house_name: "Rose Cottage",
                house_image: "agent-4-2",
                house_description: "Esse maxime totam beatae est, iusto quo voluptate ipsam nam sapiente nemo dolores adipisci vitae ex similique quam laudantium neque non aspernatur. Illum facilis amet commodi, quo hic autem ullam nobis deserunt voluptates repellat praesentium natus esse? Id suscipit obcaecati nulla aspernatur soluta cupiditate similique nobis velit fugiat nam deserunt, officiis voluptas molestias consequatur? Pariatur corporis inventore impedit accusamus consequatur dolorum quam fuga odit cumque aperiam. Laboriosam temporibus ipsum et velit modi distinctio provident nam labore vitae unde quia, animi rerum sint, exercitationem non, quidem",
                house_price: "134,000",
                house_location: "Dentore tempora, Dolorem",
                house_land_size: "400",
                no_of_bedrooms: "7",
                light_time: "18"
            },
            {
                house_name: "Gables",
                house_image: "agent-4-3",
                house_description: "Libero quis hic obcaecati ex id placeat eaque. Dolorum ad ut laborum illo quisquam rem. Quam tempore ullam dolor delectus sit cum obcaecati unde consequatur tenetur, reiciendis rem numquam nostrum porro excepturi enim fugiat officiis nihil labore harum. Odio quis recusandae id, magni corrupti quas a accusamus veniam officia dolore! Maiores officia autem aperiam doloremque modi dignissimos voluptates ipsa odit natus ut, cum ea sapiente. Cum sed ad doloribus perferendis quae. Eius hic corrupti asperiores tempora! Earum, maiores facilis ipsum esse, eum, quis laboriosam autem nesciunt distinctio harum a ea vel! Sint nulla quod qui repellendus in, libero nemo sequi a ipsum. Illo maiores illum dolore aliquam laudantium, dicta, magnam vel optio at corporis architecto doloribus aspernatur ipsa mollitia provident facilis nihil quidem natus inventore tempora dolorem neque! Fuga et officia qui a autem suscipit",
                house_price: "156,000",
                house_location: "Eius,Tempora",
                house_land_size: "700",
                no_of_bedrooms: "8",
                light_time: "20"
            }
    ...
    {
        agent_name: "Kathy Anderson",
        agent_phone_no: "+544526695148",
        agent_description: "dolorem minima explicabo labore nobis. Placeat, ipsa eos. Nostrum alias iste delectus corrupti enim nesciunt architecto doloremque rem culpa minima eius deserunt omnis ratione, voluptatem quae! Ducimus quaerat repellendus doloribus iste temporibus dolore fugiat aliquid recusandae explicabo modi cum error culpa odit commodi dolorum quisquam, vitae ea est quis aperiam minus sint dolores necessitatibus! Amet asperiores eius veniam ipsum ex impedit inventore tempora laborum eaque? Atque odit sit facere accusamus impedit consequatur esse",
        agent_image: "agent-5",
        agent_location: "Aperiam minus, Necessitatibus",
        agent_listings: [
            {
                house_name: "Springfirls",
                house_image: "agent-5-1",
                house_description: "Architecto natus ea, pariatur, neque distinctio aspernatur, dicta molestiae rem doloribus vero vel ratione error modi nihil. Repellendus fuga consequuntur, praesentium quia suscipit aperiam pariatur incidunt iste quisquam, iure hic omnis, illum officia ea autem veritatis molestias optio perspiciatis odio animi alias ducimus. Quis alias ab numquam temporibus voluptatem veniam odio dolores officiis! Libero quis",
                house_price: "200,000",
                house_location: "Doloribus, Ratione",
                house_land_size: "440",
                no_of_bedrooms: "7",
                light_time: "17"
            },
            {
                house_name: "Orchard",
                house_image: "agent-5-2",
                house_description: "Ullam nisi molestias amet, nesciunt officiis sed? Aperiam nemo laboriosam ut. Quod, sint magnam ipsa sunt dicta obcaecati libero excepturi aliquam reiciendis odio recusandae! Facilis minima ipsum aperiam unde deleniti dolorum ut architecto natus ea, pariatur, neque distinctio aspernatur, dicta molestiae rem doloribus vero vel ratione error modi nihil. Repellendus fuga consequuntur, praesentium quia suscipit aperiam pariatur incidunt iste quisquam, iure hic omnis, illum officia ea autem veritatis molestias.",
                house_price: "133,00",
                house_location: "Repelendus, Consentur",
                house_land_size: "180",
                no_of_bedrooms: "6",
                light_time: "15"
            },
            {
                house_name: "Laurels",
                house_image: "agent-5-3",
                house_description: "Exercitationem non, quidem praesentium saepe. Modi soluta ipsam, illo aut rem explicabo voluptates consequatur cumque aliquam laborum officia. Laborum quidem dolorem recusandae officia eius quibusdam facere fugit illo optio. Quod, autem aspernatur enim dignissimos laudantium ducimus vel perspiciatis alias modi numquam vero quisquam, cupiditate amet labore exercitationem non! Quidem ullam aliquid, ratione, unde incidunt qui sunt minima reiciendis aspernatur minus in nostrum, necessitatibus facere",
                house_price: "143,000",
                house_location: "Cupiditate, Exercitationem.",
                house_land_size: "840",
                no_of_bedrooms: "9",
                light_time: "12"
            }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eaS2f":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _getLocalStorage = require("./getLocalStorage");
var _getLocalStorageDefault = parcelHelpers.interopDefault(_getLocalStorage);
function populateHomeInfo(info) {
    ...
    let indices = (0, _getLocalStorageDefault.default)();
...
exports.default = populateHomeInfo;

},{"./getLocalStorage":"cmJ5L","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cmJ5L":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function getLocalStorage() {
    return localStorage.getItem("home-data") ? JSON.parse(localStorage.getItem("home-data")) : [
        {
            cardInde: 1,
            cardInfoNo: 1
        }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k4VMP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _randomHomeIndex = require("./randomHomeIndex");
var _randomHomeIndexDefault = parcelHelpers.interopDefault(_randomHomeIndex);
function populateNearCards(info) {
    ...
    nearByCards.forEach((card, index)=>{
        let i = (0, _randomHomeIndexDefault.default)(5);
        called.includes(i) ? i = (0, _randomHomeIndexDefault.default)(5) : i;
        called.push(i);
        const z = (0, _randomHomeIndexDefault.default)(3);
...
exports.default = populateNearCards;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./randomHomeIndex":"6axoE"}],"5vKjK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function showMore() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fn7T3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _getLocalStorage = require("./getLocalStorage");
var _getLocalStorageDefault = parcelHelpers.interopDefault(_getLocalStorage);
function populateAgentPage(info) {
    ...
    const indices = (0, _getLocalStorageDefault.default)();
    console.log(indices);
...
exports.default = populateAgentPage;

},{"./getLocalStorage":"cmJ5L","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k1rTf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _getLocalStorage = require("./getLocalStorage");
var _getLocalStorageDefault = parcelHelpers.interopDefault(_getLocalStorage);
...
exports.default = populateAgentListings;

},{"./getLocalStorage":"cmJ5L","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8uSH1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
function openProfile() {
    ...
    profileBtn.addEventListener("click", ()=>{
        ...
        (0, _gsapDefault.default).to(profileCover, {
            opacity: 1,
            duration: 1
        });
        (0, _gsapDefault.default).to(profileDetails, {
            yPercent: -100,
            opacity: 1,
            duration: .5,
            ease: "Expo.easeInOut"
...
},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequire5636")

//# sourceMappingURL=agent.3d214d75.js.map
